...
const TileImageBlock: FunctionComponent<Props> = ({
    blok: { image, description, price, moreDetail, component, position, _editable, _uid }
}) => {
    return (
        <BlockWrapper
            {...sbEditable({ image, description, price, component, position, _editable, _uid })}
            key={_uid}
            position={position}
        >
            {moreDetail ? (
